...
{
    FILE *arquivo = fopen("alunos.bin", "wb");  // Abre o arquivo "alunos.bin" em modo de escrita binária
...
{
    FILE *arquivo = fopen("alunos.bin", "rb");  // Abre o arquivo "alunos.bin" em modo de leitura binária
    if (arquivo == NULL)  // Verifica se houve erro na abertura do arquivo
    {
        printf("Erro ao abrir o arquivo alunos.bin\n");
        exit(1);
    ...
    printf("Número de alunos = %d\n", tamanho);  // Imprime o número de alunos recuperados do arquivo
