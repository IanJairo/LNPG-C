...
// TURMAS
/*Recupera os dados das turmas armazenadas em um arquivo e os armazena em um array de ponteiros
para objetos "Turma". Atualiza a quantidade atual de turmas.*/
void recuperarTurmasDoArquivo(Turma *turmas[], int *qtd_atual_turma);
/*Salva os dados das turmas contidos em um array de ponteiros para objetos "Turma" em um arquivo.
Recebe a quantidade atual de turmas como parâmetro.*/
